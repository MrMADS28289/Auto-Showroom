    ...
    return (
        <div className='bg-hero-pattern pt-6 md:h-[600px]'>
            <div className='flex rounded-lg justify-center mb-6'>
                <div className='font-bold bg-white text-black p-3'>FEATURED VEHICLES</div>
                <div className='font-bold bg-[#FF5400] text-white p-3'>LATEST VEHICLES</div>
            </div>
            <p className='text-white text-center'>Enjoy the ultimate car model. We are working hard to brings new advanced car interfaces to <span className='text-orange-500 font-bold'>AUOT SHOWROOM</span></p>
            <div className='grid md:grid-cols-3 mx-auto my-9 w-[1000px]'>
                {
                    newCars.map(car => {
                        return <Fade left>
