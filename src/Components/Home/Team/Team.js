    ...
    return (
        <div className='bg-team-bg text-white'>
            ...
            <div className='flex justify-center items-center my-6'>
                <img className='border-2 mx-2 border-[#FF5400] rounded-full  h-12 md:h-32 opacity-70' src="https://i.ibb.co/hFC0Ydg/leader1.jpg" alt="" />
                <img className='border-2 mx-2 border-[#FF5400] rounded-full  h-12 md:h-32 opacity-70' src="https://i.ibb.co/HYV7sjt/leader2.jpg" alt="" />
                <img className='border-2 mx-2 border-[#FF5400] rounded-full h-20 md:h-52' src="https://i.ibb.co/Vj44q52/team3.jpg" alt="" />
                <img className='border-2 mx-2 border-[#FF5400] rounded-full  h-12 md:h-32 opacity-70' src="https://i.ibb.co/n6KtQMN/team1.png" alt="" />
                <img className='border-2 mx-2 border-[#FF5400] rounded-full  h-12 md:h-32 opacity-70' src="https://i.ibb.co/LYFgZV1/team2.jpg" alt="" />
